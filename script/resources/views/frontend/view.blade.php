      ...
      <div class="col-md-8 col-sm-12">
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
              <div class="col-6 text-left"><a href="{{route('home') }}">{{translate('Back To List')}}</a></div>
              <div class="col-6 text-right">
                @if (count($message['attachments']))
                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  <span class="d_show_line"><i class="fas fa-paperclip"></i></span><span class="d_hide">{{translate('Attachments')}}</span>
                </a>
          ...
          <div class="card-body">
            <div class="info">
              <div class="row">
                ...
                <div class="col-6 text-right ov-h from">{{translate('Date')}}:<span>{{$message['receivedAt']}}</span></div>
              </div>
            </div>
            <div class="info">
              <div class="row">
                <div class="col-12 ov-h subject">{{translate('Subject')}} :<span>{{$message['subject']}}</span></div>
              </div>
            </div>

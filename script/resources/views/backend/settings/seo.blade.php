          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              <div class="alert alert-warning offset-sm-3 col-sm-6 col-md-9" role="alert">
                <strong>
                  {{__('You can modify all SEO Tags for each language . Go to language and edit translations and click SEO Tab.')}}
                </strong>
              </div>
              <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">{{__('Open Graph image')}}</label>
                <div class="col-sm-6 col-md-5">
                  <input type="file" name="og_image" class="form-control" id="site-logo-upload" />
                  <div class="form-text text-muted">{{__('The Open Graph image must have a maximum size of 5MB')}}</div>
                  <div class="mb-3">
                    <input type="hidden" class="form-control @error('og_image') is-invalid @enderror">
                    @error('og_image')
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Separator')}}</label>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Custom Tags')}}</label>
                <div class="col-sm-6 col-md-9">
                  <textarea rows="5" class="form-control @error('custom_tags') is-invalid @enderror" name="custom_tags"
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Google Tag Manager')}}</label>
                <div class="col-sm-6 col-md-9">

        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link {{empty(request()->segment(5))? 'active' : ""}}" href="{{ route('languages.show' , $language->id) }}">General</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{request()->segment(5) == "seo" ? 'active' : ""}}" href="{{ route('languages.show.seo' , $language->id) }}">Seo</a>
              </li>
            </ul>

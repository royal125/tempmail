        ...
        <form action="{{ route('settings.general.update2')}}" method="POST" autocomplete="on"
          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Invisible Recaptcha Site Key')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Invisible Recaptcha Secret Key')}}</label>
                <div class="col-sm-6 col-md-9">

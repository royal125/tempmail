...
class GeneralController extends Controller
{
    ...
    public function update2(Request $request)
    {
        ...
        $settings = Settings::whereIn('key', ['INVISIBLE_SECRET_KEY','INVISIBLE_SITE_KEY','email_lifetime_type','imap_host', 'imap_user', 'imap_pass', 'domains', 'forbidden_id', 'allowed_files','RECAPTCHA_SITE_KEY' , 'RECAPTCHA_SECRET_KEY',
